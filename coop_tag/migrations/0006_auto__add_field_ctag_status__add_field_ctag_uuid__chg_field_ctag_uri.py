...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ctag.uri'
        db.alter_column('coop_tag_ctag', 'uri', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Ctag.uri'
        db.alter_column('coop_tag_ctag', 'uri', self.gf('django.db.models.fields.CharField')(default='', max_length=250))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 30, 15, 49, 44, 398354)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 30, 15, 49, 44, 398232)'}),
        ...
        'coop_tag.ctag': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 30, 15, 49, 44, 399954)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
