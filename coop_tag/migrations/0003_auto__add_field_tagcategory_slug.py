...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TagCategory.slug'
        db.add_column('coop_tag_tagcategory', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TagCategory.slug'
        db.delete_column('coop_tag_tagcategory', 'slug')
