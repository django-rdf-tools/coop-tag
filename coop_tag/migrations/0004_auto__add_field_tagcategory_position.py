...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TagCategory.position'
        db.add_column('coop_tag_tagcategory', 'position', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TagCategory.position'
        db.delete_column('coop_tag_tagcategory', 'position')
