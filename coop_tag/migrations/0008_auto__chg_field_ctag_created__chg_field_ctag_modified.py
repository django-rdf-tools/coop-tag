...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ctag.created'
        db.alter_column('coop_tag_ctag', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Ctag.modified'
        db.alter_column('coop_tag_ctag', 'modified', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Ctag.created'
        db.alter_column('coop_tag_ctag', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Ctag.modified'
        db.alter_column('coop_tag_ctag', 'modified', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 6, 9, 17, 50, 91558)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 6, 9, 17, 50, 91424)'}),
        ...
        'coop_tag.ctag': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 6, 9, 17, 50, 88046)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'fr'", 'max_length': '10'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 6, 9, 17, 50, 88188)', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'QnNnBtYAssicChSEXk9ZFZ'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
