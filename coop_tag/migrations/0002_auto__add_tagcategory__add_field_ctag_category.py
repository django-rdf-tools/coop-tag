...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('coop_tag_tagcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('uri', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ))
        db.send_create_signal('coop_tag', ['TagCategory'])

        # Adding field 'Ctag.category'
        db.add_column('coop_tag_ctag', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_tag.TagCategory'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'TagCategory'
        db.delete_table('coop_tag_tagcategory')

        # Deleting field 'Ctag.category'
        db.delete_column('coop_tag_ctag', 'category_id')
